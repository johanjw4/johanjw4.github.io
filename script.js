...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const validPass = "wachtwoord123"; // Voeg je logica toe voor een dynamisch wachtwoord
  ...
  // Show panel na succesvolle login
